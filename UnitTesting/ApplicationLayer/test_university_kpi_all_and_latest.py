...
EXPECTED_SUCCESS_ENDPOINTS = [
    (University_KPI_History_Check, (1,'employment_rate_2_years_after_graduating_field')),
    (University_KPI_History_Check, (5,'employment_rate_6_months_after_graduating_field')),
